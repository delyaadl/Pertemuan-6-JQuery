const API_KEY = '2407af0469989eadddd492e6f14da769';
...
// search movie ketika button diklik
// cara biasa document.getElemenById, kalau pake jQuery tinggal $('id atau class atau apalahnya')
$('#searchButton').click((e) => {
    
    // menghapus error jika ada
    $('#error').text('');
    
    // disabled button search untuk mencegah user ngeklik 2 kali waktu loading
    $('#searchButton')
        .empty()
...
function createCell(movie) {
    ...
    // rating
    const rating = $('<span class="badge badge-success p-2"></span>').text(movie.rating);
    td.append(rating);
